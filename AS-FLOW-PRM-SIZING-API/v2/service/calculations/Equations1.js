const { getConstants, getConstantsWithName, convertUnit, convertUnitDiffDims, kdCalculation, knCalculation, ValidateExpression, KbKwValidateExpressions, IsCriticalFlow, KdKxCheck } = require('../../utils/helper');
...
const Equation_1p3a = (Kx, A, P1, Fs, M, T, Z, CM) => {
    // Usage				Variable				EnglishUnits				MetricUnits				Description																	
    ...
    const N1 = Number(getConstantsWithName(CM, 'N1'));
    A = convertUnit(A, 'in2', 'cm2');
    P1 = convertUnit(P1, 'psia', 'bara');
    T = convertUnit(T, '°R', '°K');
