...
const FireCasePopup = ({fields, handleChange,handleBlur,handleFocusedFieldName,selectedFields,selectedData,error, ...prop}) => {
    ...
    const fetchField=(field,index)=>{
        ...
        // console.log('Popup Change 11111 >>>>>>>>>>>> 9999999 >>> In FireCasePopup >>>>>>>>>>>>>>>>>>',field?.fieldName,field?.type,field?.fieldList,field?.visibility,field?.key)
        switch(field.type) {
            case 'label':
    ...
    {width:1000,minHeight:250,overflow:'auto'} //:{width:1000,minHeight:350,overflow:'auto'}
    }
    >
